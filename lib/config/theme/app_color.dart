...
class AppColors {
  // Main Colors
  static const Color primary = Color(0xffE21221);
  ...
  static const Color disabledButton = Color(0xffC1232F);
  ...
  // Background Colors
  static const Color backgroundRed = Color(0xffFFF5F6);
  ...
  // Transparent Colors
  static const Color redTransparent = Color(0xffE21221);
